    ...
    <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
      ...
      <div class="text-center">
        ...
        <h1 class="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-neutral-200">
          Creating Trends <span class="text-blue-500">One Event at a Time.</span>
        </h1>
      </div>
      <!-- End Title -->
      ...
      <div class="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
        <div class="shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
          ...
          <div class="flex justify-center -space-x-3">
            ...
            <span class="inline-flex items-center justify-center size-8 rounded-full ring-2 ring-white bg-gray-800 dark:bg-neutral-900 dark:ring-neutral-900">
              <span class="text-xs font-medium text-white uppercase">70+</span>
            </span>
          </div>
          <!-- End Avatar Group -->
        </div>
        ...
        <div class="pt-5 sm:pt-0 sm:ps-5">
          ...
          <div class="text-sm text-gray-500 dark:text-neutral-500">Join

992
+

others on the waitlist</div>
        </div>
      </div>
      <!-- End Avatar Group -->
      ...
      <form @submit.prevent="submitLead">
        <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border border-gray-200 rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20">
          <div class="w-full pb-2 sm:pb-0">
            ...
            <input v-model="name" id="hs-hero-name-1" class="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Your name">
          </div>
          <div class="pt-2 sm:pt-0 sm:ps-3 border-t border-gray-200 sm:border-t-0 sm:border-s w-full dark:border-neutral-700">
            ...
            <input v-model="email" type="email" id="hs-hero-email-1" class="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Email address">
          </div>
          <button
  type="submit"
  class="py-3 px-4 whitespace-nowrap inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
>
  Join Waitlist
</button>
        </div>
